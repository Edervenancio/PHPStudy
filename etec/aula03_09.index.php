<?php
include_once 'aula_03_09.funcoes.php'; // inclui o arquivo
...
// $total =  contarCacteress('Etec Dr carolino da motta e silva');
///echo "<br> Total de caracteres:" . $total;

//$palavra= maiusculaMinusculaa('sao paulo', '');
//echo $palavra;
